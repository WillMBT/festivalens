...
class FestivaLensApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(scaffoldBackgroundColor: Color(0xff2B2D42)),
    );
  }
}
...
class _FestivaLensHomePageState extends State<FestivaLensHomePage> {
  ...
  final color = Color(0xff2B2D42);
  final color2 = Color(0xffF7EBEC);
  final color3 = Color(0xffDDBDD5);
  final color4 = Color(0xff7FD1B9);
  final color5 = Color(0xffFAB378);
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.home, color: Color(0xff7FD1B9)),
            label: 'Home',
            
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.event, color: Color(0xffF7EBEC)),
            label: 'Events',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.location_on, color: Color(0xffF7EBEC)),
            label: 'Map',
          ),
          
          BottomNavigationBarItem(
            icon: Icon(Icons.file_upload_outlined, color: Color(0xffF7EBEC)),
            label: 'Upload',
          ),
          
          BottomNavigationBarItem(
            icon: Icon(Icons.person, color: Color(0xffF7EBEC)),  // New Profile Icon
            label: 'Profile',
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: event['source'] == 'eventfinda' ?  Color(0xff7FD1B9): (event['source'] == 'moshtix' ? Color(0xffFAB378): Color(0xffDDBDD5)),
